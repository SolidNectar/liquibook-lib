...
export const markets = $root.markets = (() => {
    ...
    markets.Price = (function() {
        ...
        Price.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Price";
        };
    ...
    markets.BBO = (function() {
         ...
         * @returns {string} The default type url
         */
        BBO.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.BBO";
        };
    ...
    markets.Trade = (function() {
        ...
        Trade.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.tradePrice != null && Object.hasOwnProperty.call(message, "tradePrice"))
            ...
            if (message.bidID != null && Object.hasOwnProperty.call(message, "bidID"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.bidID);
            if (message.askID != null && Object.hasOwnProperty.call(message, "askID"))
        ...
        Trade.toObject = function toObject(message, options) {
            ...
            if (message.taker != null && message.hasOwnProperty("taker"))
                object.taker = options.enums === String ? $root.markets.Side[message.taker] === undefined ? message.taker : $root.markets.Side[message.taker] : message.taker;
            if (message.bidID != null && message.hasOwnProperty("bidID"))
        ...
        Trade.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Trade";
        };
    ...
    markets.Trades = (function() {
        ...
        Trades.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Trades";
        };
    ...
    markets.NewOrder = (function() {
        ...
        NewOrder.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.clOrdID != null && Object.hasOwnProperty.call(message, "clOrdID"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.clOrdID);
            if (message.orderIDParent != null && Object.hasOwnProperty.call(message, "orderIDParent"))
        ...
        NewOrder.toObject = function toObject(message, options) {
            ...
            if (message.side != null && message.hasOwnProperty("side"))
                object.side = options.enums === String ? $root.markets.Side[message.side] === undefined ? message.side : $root.markets.Side[message.side] : message.side;
            if (message.orderType != null && message.hasOwnProperty("orderType"))
                object.orderType = options.enums === String ? $root.markets.OrderType[message.orderType] === undefined ? message.orderType : $root.markets.OrderType[message.orderType] : message.orderType;
            if (message.price != null && message.hasOwnProperty("price"))
                if (typeof message.price === "number")
                    object.price = options.longs === String ? String(message.price) : message.price;
                else
         ...
         * @returns {string} The default type url
         */
        NewOrder.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.NewOrder";
        };
    ...
    markets.ClientKey = (function() {
        ...
        ClientKey.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.pocketID != null && Object.hasOwnProperty.call(message, "pocketID"))
         ...
         * @returns {string} The default type url
         */
        ClientKey.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.ClientKey";
        };
    ...
    markets.CancelOrder = (function() {
        ...
        /**
         * CancelOrder orderID.
         * @member {number|null|undefined} orderID
         * @memberof markets.CancelOrder
         * @instance
         */
        CancelOrder.prototype.orderID = null;
        ...
        CancelOrder.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.CancelOrder";
        };
    ...
    markets.CancelStatus = (function() {
        ...
        CancelStatus.toObject = function toObject(message, options) {
            ...
            if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                object.timestamp = $root.google.protobuf.Timestamp.toObject(message.timestamp, options);
            if (message.code != null && message.hasOwnProperty("code"))
                object.code = options.enums === String ? $root.markets.CancelStatusCode[message.code] === undefined ? message.code : $root.markets.CancelStatusCode[message.code] : message.code;
            if (message.reason != null && message.hasOwnProperty("reason"))
         ...
         * @returns {string} The default type url
         */
        CancelStatus.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.CancelStatus";
        };
    ...
    markets.ModifyOrder = (function() {
        ...
        ModifyOrder.encode = function encode(message, writer) {
            ...
            if (message.modifyType != null && Object.hasOwnProperty.call(message, "modifyType"))
        ...
        ModifyOrder.fromObject = function fromObject(object) {
            ...
            default:
                if (typeof object.modifyType === "number") {
                    message.modifyType = object.modifyType;
                    break;
                }
                break;
            case "PRICE":
        ...
        ModifyOrder.toObject = function toObject(message, options) {
            ...
            if (message.orderID != null && message.hasOwnProperty("orderID"))
                object.orderID = message.orderID;
            if (message.modifyType != null && message.hasOwnProperty("modifyType"))
                object.modifyType = options.enums === String ? $root.markets.ModifyType[message.modifyType] === undefined ? message.modifyType : $root.markets.ModifyType[message.modifyType] : message.modifyType;
            if (message.price != null && message.hasOwnProperty("price"))
                if (typeof message.price === "number")
                    object.price = options.longs === String ? String(message.price) : message.price;
                else
        ...
        ModifyOrder.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.ModifyOrder";
        };
    ...
    markets.Action = (function() {
        ...
        Action.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Action";
        };
    ...
    markets.Fill = (function() {
        ...
        Fill.encode = function encode(message, writer) {
            ...
            if (message.took != null && Object.hasOwnProperty.call(message, "took"))
        ...
        Fill.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Fill";
        };
    ...
    markets.FillEvent = (function() {
         ...
         * @returns {string} The default type url
         */
        FillEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.FillEvent";
        };
    ...
    markets.FillEventList = (function() {
         ...
         * @returns {string} The default type url
         */
        FillEventList.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.FillEventList";
        };
    ...
    markets.OrderStatusEvent = (function() {
         ...
         * @instance
         */
        OrderStatusEvent.prototype.reason = null;
        ...
        OrderStatusEvent.toObject = function toObject(message, options) {
            ...
            if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                object.timestamp = $root.google.protobuf.Timestamp.toObject(message.timestamp, options);
            if (message.code != null && message.hasOwnProperty("code"))
                object.code = options.enums === String ? $root.markets.OrderStatusCode[message.code] === undefined ? message.code : $root.markets.OrderStatusCode[message.code] : message.code;
            if (message.reason != null && message.hasOwnProperty("reason")) {
                object.reason = message.reason;
                if (options.oneofs)
                    object.msg = "reason";
         ...
         * @returns {string} The default type url
         */
        OrderStatusEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.OrderStatusEvent";
        };
    ...
    markets.OrderStatus = (function() {
        ...
        OrderStatus.encode = function encode(message, writer) {
            ...
            if (message.filled != null && Object.hasOwnProperty.call(message, "filled"))
                writer.uint32(/* id 5, wireType 0 =*/40).uint64(message.filled);
            if (message.filledCost != null && Object.hasOwnProperty.call(message, "filledCost"))
        ...
        OrderStatus.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.OrderStatus";
        };
    ...
    markets.Order = (function() {
        ...
        Order.toObject = function toObject(message, options) {
            ...
            if (message.timestamp != null && message.hasOwnProperty("timestamp"))
                object.timestamp = $root.google.protobuf.Timestamp.toObject(message.timestamp, options);
            if (message.status != null && message.hasOwnProperty("status"))
                object.status = options.enums === String ? $root.markets.OrderStatusCode[message.status] === undefined ? message.status : $root.markets.OrderStatusCode[message.status] : message.status;
            if (message.filled != null && message.hasOwnProperty("filled"))
                if (typeof message.filled === "number")
                    object.filled = options.longs === String ? String(message.filled) : message.filled;
                else
        ...
        Order.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Order";
        };
    ...
    markets.OrderList = (function() {
        ...
        OrderList.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.OrderList";
        };
    ...
    markets.Date = (function() {
        ...
        Date.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Date";
        };
    ...
    markets.px = (function() {
         ...
         * @returns {string} The default type url
         */
        px.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.px";
        };
    ...
    markets.sz = (function() {
         ...
         * @returns {string} The default type url
         */
        sz.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.sz";
        };
    ...
    markets.Summary = (function() {
        ...
        Summary.encode = function encode(message, writer) {
            ...
            if (message.closePrior24 != null && Object.hasOwnProperty.call(message, "closePrior24"))
                $root.markets.px.encode(message.closePrior24, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.closePrior != null && Object.hasOwnProperty.call(message, "closePrior"))
            ...
            if (message.high24 != null && Object.hasOwnProperty.call(message, "high24"))
            ...
            if (message.low24 != null && Object.hasOwnProperty.call(message, "low24"))
            ...
            if (message.lastQty != null && Object.hasOwnProperty.call(message, "lastQty"))
                $root.markets.sz.encode(message.lastQty, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            if (message.lastQtyCum != null && Object.hasOwnProperty.call(message, "lastQtyCum"))
                $root.markets.sz.encode(message.lastQtyCum, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
            if (message.lastPrior != null && Object.hasOwnProperty.call(message, "lastPrior"))
            ...
            if (message.volume24 != null && Object.hasOwnProperty.call(message, "volume24"))
                $root.markets.sz.encode(message.volume24, writer.uint32(/* id 17, wireType 2 =*/138).fork()).ldelim();
            if (message.volumeCum != null && Object.hasOwnProperty.call(message, "volumeCum"))
            ...
            if (message.bidQty != null && Object.hasOwnProperty.call(message, "bidQty"))
                $root.markets.sz.encode(message.bidQty, writer.uint32(/* id 20, wireType 2 =*/162).fork()).ldelim();
            if (message.bidPrior != null && Object.hasOwnProperty.call(message, "bidPrior"))
            ...
            if (message.askQty != null && Object.hasOwnProperty.call(message, "askQty"))
                $root.markets.sz.encode(message.askQty, writer.uint32(/* id 23, wireType 2 =*/186).fork()).ldelim();
            if (message.askPrior != null && Object.hasOwnProperty.call(message, "askPrior"))
            ...
            if (message.open24 != null && Object.hasOwnProperty.call(message, "open24"))
        ...
        Summary.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Summary";
        };
    ...
    markets.Position = (function() {
         ...
         * @instance
         */
        Position.prototype.available = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        Position.encode = function encode(message, writer) {
            ...
            if (message.available != null && Object.hasOwnProperty.call(message, "available"))
                writer.uint32(/* id 1, wireType 0 =*/8).int64(message.available);
            if (message.open != null && Object.hasOwnProperty.call(message, "open"))
        ...
        Position.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Position";
        };
    ...
    markets.Wallet = (function() {
         ...
         * @property {number|null} [id] Wallet id
         */
        ...
        Wallet.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Wallet";
        };
    ...
    markets.Pocket = (function() {
         ...
         * @returns {string} The default type url
         */
        Pocket.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.Pocket";
        };
    ...
    markets.Interval = (function() {
        ...
        Interval.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Interval";
        };
    ...
    markets.Segment = (function() {
        ...
        Segment.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Segment";
        };
    ...
    markets.Continuum = (function() {
         ...
         * @returns {string} The default type url
         */
        Continuum.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/markets.Continuum";
        };

        return Continuum;
    })();

    markets.Activity = (function() {

        /**
         * Properties of an Activity.
         * @memberof markets
         * @interface IActivity
         * @property {number|null} [id] Activity id
         * @property {google.protobuf.ITimestamp|null} [timestamp] Activity timestamp
         * @property {number|null} [profileId] Activity profileId
         * @property {string|null} [type] Activity type
         * @property {string|null} [level] Activity level
         * @property {string|null} [action] Activity action
         * @property {number|null} [actionId] Activity actionId
         * @property {string|null} [data] Activity data
         * @property {boolean|null} [unread] Activity unread
         */
         ...
         * @constructor
         * @param {markets.IActivity=} [properties] Properties to set
         */
         ...
         * Activity id.
         * @member {number} id
         * @memberof markets.Activity
         * @instance
         */
        Activity.prototype.id = 0;
         ...
         * @instance
         */
        Activity.prototype.timestamp = null;
         ...
         * @instance
         */
        Activity.prototype.profileId = 0;
         ...
         * @instance
         */
        Activity.prototype.unread = false;
         ...
         * @static
         * @param {markets.IActivity=} [properties] Properties to set
         * @returns {markets.Activity} Activity instance
         */
         ...
         * @memberof markets.Activity
         * @static
         * @param {markets.IActivity} message Activity message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        Activity.encode = function encode(message, writer) {
            ...
            if (message.actionId != null && Object.hasOwnProperty.call(message, "actionId"))
                writer.uint32(/* id 7, wireType 0 =*/56).uint32(message.actionId);
            ...
            if (message.unread != null && Object.hasOwnProperty.call(message, "unread"))
                writer.uint32(/* id 9, wireType 0 =*/72).bool(message.unread);
            return writer;
        };
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {markets.Activity} Activity
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Activity.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.markets.Activity();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Activity.fromObject = function fromObject(object) {
            if (object instanceof $root.markets.Activity)
                return object;
            let message = new $root.markets.Activity();
            if (object.id != null)
                message.id = object.id >>> 0;
            if (object.timestamp != null) {
                if (typeof object.timestamp !== "object")
                    throw TypeError(".markets.Activity.timestamp: object expected");
                message.timestamp = $root.google.protobuf.Timestamp.fromObject(object.timestamp);
            }
            if (object.profileId != null)
                message.profileId = object.profileId >>> 0;
         ...
         * @memberof markets.Activity
         * @static
         * @param {markets.Activity} message Activity
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        Activity.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/markets.Activity";
        };
